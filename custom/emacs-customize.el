...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck-ghcmod flycheck-haskell company-ghc xah-math-input web-mode tangotango-theme projectile php-auto-yasnippets nlinum helm haskell-mode geben flycheck boron-theme auto-complete))))
(custom-set-faces
