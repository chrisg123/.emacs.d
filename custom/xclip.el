...
(defun enable-clipboard ()
  "Enable clipboard integration based on OS detection."
  (interactive)
  (pcase (detect-os)
    ('wsl
     (setq interprogram-cut-function 'clip-exe-cut-function
           interprogram-paste-function 'powershell-clipboard-paste))
    ('windows
     (setq interprogram-cut-function 'clip-exe-cut-function
           interprogram-paste-function 'powershell-clipboard-paste))
    ('linux
    ...
    (_
     (message "Clipboard integration not configured for this OS."))))


(add-hook 'after-init-hook #'enable-clipboard)
