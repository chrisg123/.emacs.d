...
(eval-and-compile
  (defvar vbnet-all-keywords
    '("Add" "AddHandler""AddressOf" "Aggregate" "And" "AndAlso" "App" "AppActivate" "Application" "Array" "As"
      ...
      "If" "Implements" "In" "InStr" "Input" "Int" "Integer" "Interface" "Is" "IsArray" "IsDate"
      "IsEmpty" "IsError" "IsMissing" "IsNot" "IsNull" "IsNumeric" "IsObject" "Kill" "Key"
      ...
      "Pmt" "Print" "Printer" "Printers" "Private" "ProjectTemplate" "Protected"
      "Property"
